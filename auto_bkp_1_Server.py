...
caminho = r"J:\Grupo L2R\Servidor de Arquivos - GRV\Itaguai_RJ\mover" + "\\" # Declarando variável para informar a localização da pasta - Caso seja na mesma pasta do projeto, não precisa

destino = r"J:\Grupo L2R\Servidor de Arquivos - GRV\Itaguai_RJ\organizados" + "\\" # Declarando variável para informar a localização da pasta de destino

duplicados= r"J:\Grupo L2R\Servidor de Arquivos - GRV\Itaguai_RJ\duplicados" + "\\" # Declarando variável para informar a localização da pasta de duplicatas
